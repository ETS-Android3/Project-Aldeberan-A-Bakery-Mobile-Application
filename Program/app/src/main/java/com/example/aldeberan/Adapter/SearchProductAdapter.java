...
public class SearchProductAdapter extends RecyclerView.Adapter<SearchProductAdapter.ProductViewHolder>{
    ...
    public SearchProductAdapter(Context mContext, List<Product> mData, FragmentCommunication mCommunicator, GuestFragmentCommunication guestFragmentCommunication) {
    ...
    public class ProductViewHolder extends RecyclerView.ViewHolder{
        ...
        public ProductViewHolder(ProductCardBinding productCardBinding, SearchProductAdapter.FragmentCommunication mCommunication, SearchProductAdapter.GuestFragmentCommunication guestFragmentCommunication) {
    ...
    public SearchProductAdapter.ProductViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType){
        ...
        SearchProductAdapter.ProductViewHolder holder = new SearchProductAdapter.ProductViewHolder(productCardBinding, mCommunicator, guestFragmentCommunication);
        return holder;
    }
